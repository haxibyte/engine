...
vars = {
  ...
  'gitee_dart_git': 'https://gitee.com/alexanderzhu',
  ...
  'gitee_dart_revision': 'ea5018d50a83575a57d6f94b6c341209ae7b5ea1',
...
deps = {
  'src': 'https://github.com/haxibyte/buildroot.git' + '@' + '9b6a8d378a8bbad15c867bb77a19d3a36d7e4c5b',
  ...
  'src/third_party/dart':
   Var('gitee_dart_git') + '/dart.git' + '@' + Var('gitee_dart_revision'),
